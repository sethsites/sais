defmodule SaisWeb.Components.CheckboxField do
  @moduledoc """
  SaisWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
