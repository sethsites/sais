defmodule SaisWeb.Components.Tabs do
  @moduledoc """
  `SaisWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import SaisWeb.Components.Badge, only: [badge: 1]
