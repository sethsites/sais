defmodule SaisWeb.Components.Divider do
  @moduledoc """
  The `SaisWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `SaisWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
