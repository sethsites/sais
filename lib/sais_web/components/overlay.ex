defmodule SaisWeb.Components.Overlay do
  @moduledoc """
  The `SaisWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `SaisWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
