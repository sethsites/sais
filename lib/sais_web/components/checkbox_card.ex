defmodule SaisWeb.Components.CheckboxCard do
  @moduledoc """
  The `SaisWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
