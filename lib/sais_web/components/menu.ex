defmodule SaisWeb.Components.Menu do
  @moduledoc """
  The `SaisWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `SaisWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import SaisWeb.Components.Accordion, only: [accordion: 1]
  import SaisWeb.Components.Button, only: [button_link: 1]
