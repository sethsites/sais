defmodule SaisWeb.Components.NativeSelect do
  @moduledoc """
  The `SaisWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `SaisWeb.Components.NativeSelect`
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SaisWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SaisWeb.Gettext, "errors", msg, opts)
    end
  end
