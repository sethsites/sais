defmodule SaisWeb.Components.Banner do
  @moduledoc """
  SaisWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
