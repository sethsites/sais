defmodule SaisWeb.Components.Spinner do
  @moduledoc """
  The `SaisWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `SaisWeb.Components.Spinner` module enables developers to provide
