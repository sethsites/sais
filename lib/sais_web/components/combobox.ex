defmodule SaisWeb.Components.Combobox do
  @moduledoc """
  The `SaisWeb.Components.Combobox` is a Phoenix LiveView component module for creating customizable combobox elements.
  ...
  use Gettext, backend: SaisWeb.Gettext
